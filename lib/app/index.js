...
var divs = [
    ...
    React.createElement(Wrapper, { count: 1, key: 26, header: "改进模型 LSTM-RTRBM" },
        React.createElement(ReactPPT_1.Lists, { header: true, lists: ["受限玻尔兹曼机 RBM"] },
            ...
            React.createElement(ReactPPT_1.Frame3, { order: 1, animation: { animation: "transition.bounceUpIn" } },
