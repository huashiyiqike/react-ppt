...
var divs = [
    ...
    React.createElement(Wrapper, { count: 1, key: 3, header: " " },
        React.createElement(ReactPPT_1.Frame3, { order: 0, animate: { animation: "transition.bounceUpIn", duration: 500 } },
            React.createElement("img", { style: { position: 'absolute', left: "0%", top: "1%", height: '90%' }, src: "../lib/app/static/xiaobing.jpg" })),
        React.createElement(ReactPPT_1.Frame3, { order: 1, animate: { animation: "transition.bounceUpIn", duration: 500 } },
            React.createElement("img", { style: { position: 'absolute', left: "50%", top: "15%", height: '80%' }, src: "../lib/app/static/xiaohuangji2.jpg" }))),
        ...
        React.createElement("ul", { className: "list" },
            React.createElement(ReactPPT_1.Frame3, { order: 0, animate: { animation: "transition.bounceUpIn", duration: 500, stagger: 200 } },
                ...
                React.createElement(ReactPPT_1.Frame3, { order: 2, animate: { animation: "transition.bounceUpIn", duration: 500, stagger: 200 } },
                    ...
                    React.createElement("li", { style: { color: 'red' } }, "\u79BB\u6563\u72B6\u6001 GMM"),
                    React.createElement("li", { style: { color: 'red' } }, "\u72B6\u6001\u6570\u91CF\u6709\u9650 \u8F6C\u79FB\u77E9\u9635"),
                    React.createElement("li", { style: { color: 'red' } }, "\u65F6\u95F4\u5E8F\u5217\u957F\u5EA6\u4F9D\u8D56\u6709\u9650"))))),
    React.createElement(Wrapper, { count: 1, key: 7, header: "研究现状" },
        React.createElement("ul", { className: "list" },
            React.createElement(ReactPPT_1.Frame3, { order: [0, 1], animate: { animation: "transition.bounceUpIn", duration: 500, stagger: 200 }, animateOut: { animation: "transition.bounceUpOut", duration: 500, stagger: 200 } },
                React.createElement(ReactPPT_1.Lists, { header: true, lists: ["普通递归神经网络RNN"] }),
                React.createElement("li", null, "\u80FD\u5145\u5206\u5229\u7528\u65F6\u5E8F\u4FE1\u606F\uFF0C\u5177\u6709\u50A8\u5B58\u8BB0\u5FC6\u80FD\u529B"),
                React.createElement("li", { style: { color: 'red' } }, "\u96BE\u4EE5\u8BAD\u7EC3\uFF0C\u53CD\u5411\u4F20\u64AD\u968F\u65F6\u95F4\u5C55\u5F00\u5BFC\u81F4\u68AF\u5EA6\u7206\u70B8"),
                React.createElement("li", { style: { color: 'red' } }, "\u6A21\u578B\u8FC7\u4E8E\u7B80\u5355\uFF0C\u5EFA\u6A21\u80FD\u529B\u6709\u9650"),
                React.createElement("li", { style: { color: 'red' } }, "Hessian Free\u4F18\u5316 \u80FD\u4E00\u5B9A\u7A0B\u5EA6\u7F13\u89E3\u95EE\u9898\uFF0C\u4F46\u4E0D\u80FD\u89E3\u51B3\u6A21\u578B\u672C\u8EAB\u7684\u7F3A\u9677")),
            React.createElement(ReactPPT_1.Frame3, { order: 1, animate: { animation: "transition.bounceUpIn", duration: 500, stagger: 200 } },
                ...
                React.createElement("li", { style: { color: 'red' } }, "\u7F51\u7EDC\u8FDE\u63A5\u6743\u91CD\u9884\u8BBE\uFF0C\u5982\u4F55\u8BBE\u7F6E\u6CA1\u6709\u5B9A\u8BBA"),
                React.createElement("li", { style: { color: 'red' } }, "\u6CDB\u5316\u80FD\u529B\u5F31")))),
    React.createElement(Wrapper, { count: 1, key: 8, header: "研究现状" },
        React.createElement("ul", { className: "list" },
            React.createElement(ReactPPT_1.Frame3, { order: 0, animate: { animation: "transition.bounceUpIn", duration: 500, stagger: 200 } },
                ...
                React.createElement("li", { style: { color: 'red' } }, "\u957F\u65F6\u8BB0\u5FC6\u80FD\u529B\u4E0D\u8DB3"),
                React.createElement("li", { style: { color: 'red' } }, "\u4ECD\u7136\u5B58\u5728\u68AF\u5EA6\u7206\u70B8\u95EE\u9898\uFF0C\u96BE\u4EE5\u8BAD\u7EC3")))),
    React.createElement(Wrapper, { count: 1, key: 9, header: "研究现状" },
        React.createElement("ul", { className: "list" },
            React.createElement(ReactPPT_1.Frame3, { order: 0, animate: { animation: "transition.bounceUpIn", duration: 500, stagger: 200 } },
                ...
                React.createElement("li", { style: { color: 'red' } }, "\u5355\u4E00\u65F6\u95F4\u6B65\u5EFA\u6A21\u80FD\u529B\u5F31")))),
    ...
    React.createElement(Wrapper, { key: 14, count: 4, header: "长时短时记忆模型" },
        ...
        React.createElement("ul", { className: "list" },
            React.createElement(ReactPPT_1.Lists, { header: true, lists: ["贡献1 -- 训练方法"] }),
    ...
    React.createElement(Wrapper, { key: 18, header: "贡献2 -- 优化算法" },
        React.createElement("ul", { className: "list" },
    ...
    React.createElement(Wrapper, { key: 19, header: "贡献2 -- 优化算法 实验" },
        React.createElement("img", { src: "../lib/app/static/lbfgs.png" })),
    React.createElement(Wrapper, { key: 20, count: 3, header: "贡献3 -- 门函数激励函数" },
    ...
    React.createElement(Wrapper, { count: 1, key: 26, header: "贡献5 -- 改进模型 LSTM-RTRBM" },
        React.createElement(ReactPPT_1.Lists, { header: true, lists: ["受限玻尔兹曼机 RBM"] },
            ...
            React.createElement(ReactPPT_1.Frame3, { order: 1, animate: { animation: "transition.bounceUpIn" } },
                React.createElement("img", { src: '../lib/app/static/rbm.png', style: { height: '40%', position: 'absolute', bottom: '20px', left: '40%' } })))),
    React.createElement(Wrapper, { count: 3, key: 26, header: "贡献5 -- 改进模型 LSTM-RTRBM" },
        React.createElement(ReactPPT_1.Frame3, { animate: { animation: "transition.bounceUpIn" }, order: 0 },
        ...
        React.createElement(ReactPPT_1.Frame3, { animate: { animation: "transition.bounceUpIn" }, order: 1 },
            React.createElement("div", { style: { position: 'relative' } },
                ...
                React.createElement("img", { style: { width: "900px", height: "450px" }, src: '../lib/app/static/lstm-rtrbm.png' })))),
    ...
    React.createElement(Wrapper, { key: 'end', header: "研究成果" },
        React.createElement("ul", { className: "list" },
            React.createElement("li", null,
                "Qi Lyu and Jun Zhu. Revisit Long Short-Term Memory: An Optimization Perspective. In Conference on Neural Information Processing Systems (NIPS) Workshop on Deep Learning and Representation Learning, Montreal, Canada, 2014(",
                React.createElement("span", { style: { color: 'red' } }, " NIPS "),
                ")"),
            React.createElement("li", null,
                "Qi Lyu, Zhiyong Wu, Jun Zhu, Helen Meng. Modelling High-Dimensional Sequences with LSTM-RTRBM: Application to Polyphonic Music Generation. In Proceedings of the Twenty-Fourth International Joint Conference on Artificial Intelligence (IJCAI 2015), 4138 (",
                React.createElement("span", { style: { color: 'red' } }, " IJCAI, EI\u6536\u5F55"),
                ")"),
            React.createElement("li", null,
                "Qi Lyu, Zhiyong Wu, Jun Zhu. Polyphonic Music Modelling with LSTM-RTRBM. In Proc. of ACM Multimedia, Brisbane, Australia, 2015. (ACM MM 2015) (",
                React.createElement("span", { style: { color: 'red' } }, " ACM MM, EI\u6536\u5F55"),
                ")"))),
    React.createElement(Wrapper, { count: 8, key: 'end', header: "开源贡献" },
        React.createElement(ReactPPT_1.Frame3, { order: [0, 1], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { style: { position: 'absolute', right: '100px', top: '50px', height: '650px', zIndex: 0 }, src: '../lib/app/static/github.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: [1, 2], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter1.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: [2, 3], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter2.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: [3, 4], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter9.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: [4, 5], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter4.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: [5, 6], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter5.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: [6, 7], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter6.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: [7, 8], animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter7.png' })),
        React.createElement(ReactPPT_1.Frame3, { order: 8, animate: { animation: "transition.perspectiveLeftIn", duration: 500, stagger: 400 }, animateOut: { animation: "transition.perspectiveRightOut", duration: 200, stagger: 100 } },
            React.createElement("img", { src: '../lib/app/static/letter8.png' }))),
    React.createElement(Wrapper, { key: -1, header: "培养方案完成情况" },
        React.createElement("ul", { className: "list" },
            React.createElement(ReactPPT_1.Lists, { header: true, lists: ["学分"] },
                React.createElement("li", null, "\u57F9\u517B\u8BA1\u5212\u5DF2\u4FEE\u6EE132\u5B66\u4F4D\u8BFE\u5B66\u5206+2\u975E\u5B66\u4F4D\u5B66\u5206")),
            React.createElement(ReactPPT_1.Lists, { header: true, lists: ["专业实践"] },
                React.createElement("li", null, "\u767E\u5EA6\u6DF1\u5EA6\u5B66\u4E60\u7814\u7A76\u9662\u6DF1\u5EA6\u5B66\u4E60\u7B97\u6CD5\u5B9E\u4E60"),
                React.createElement("li", null, "Intel\u6DF1\u5EA6\u5B66\u4E60\u5E73\u53F0\u7814\u53D1")),
            React.createElement(ReactPPT_1.Lists, { header: true, lists: ["所获奖励"] },
                React.createElement("li", null, "\u9662\u8BBE\u666F\u829D\u4E8C\u7B49\u5956\u5B66\u91D1"),
                React.createElement("li", null, "\u56FD\u5BB6\u5956\u5B66\u91D1")))),
