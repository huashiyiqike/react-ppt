...
var divs = [
    ...
    React.createElement(Wrapper, { key: 2, header: "提纲" },
        React.createElement("ul", { className: "list" },
            ...
            React.createElement(ReactPPT_1.Lists, { header: true, lists: ["主要研究内容"] },
                React.createElement(ReactPPT_1.Lists, { lists: ["长时短时记忆模型优化",
                        "LSTM-RTRBM模型"] })),
            React.createElement(ReactPPT_1.Lists, { header: true, lists: ["论文主要工作与贡献总结"] }))),
    ...
    React.createElement(ReactPPT_1.Frame3, { count: 1, key: 8, order: 1, animate: { animation: "transition.fadeIn" } },
...
ReactDOM.render(React.createElement(ReactPPT_1.ReactPPT, { content: divs, cur: 7 }), document.querySelector('#content'));
