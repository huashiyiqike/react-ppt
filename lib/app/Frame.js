...
var Frame3 = (function (_super) {
    ...
    Frame3.prototype.render = function () {
        ...
        return React.createElement("div", { count: this.props.count },
            React.createElement(velocity_react_1.VelocityTransitionGroup, __assign({}, this.props.Store.currentCount >= this.props.order ? {
                enter: { animation: "transition.fadeIn", stagger: 600 },
                runOnMount: true,
            } : {}),
                this.props.children,
                React.createElement(velocity_react_1.VelocityComponent, { animation: { "transition.fadeIn": this.props.Store.currentCount >= this.props.order ? 1 : 0 }, duration: 500 },
                    React.createElement("div", null, "fdsfsfjkhjjdfsf"))));
    };
    return Frame3;
}(React.Component));
